...
<page orientation="portrait" >
    ...
    <table cellspacing="0" style="width: 100%; margin: 3%;">
        ...
        <tr>
            <td style="width: 100%; text-align: center; text-decoration: underline; font-weight: bold; font-size: 20pt">
                ...
                REPORTE DE EQUIPOS POR ESTADOS
            </td>
        </tr>
    </table>
    ...
    <table cellspacing="0" style="padding: 1px; width: 100%; border: solid 2px #000000; font-size: 11pt; ">
        ...
        <tr>
            ...
            <th style="width: 15%; border: solid 1px #000000; text-align: center;">Estados</th>
        </tr>


        <?php foreach($equipos as $equipo):?>
            <?php $estado = $equipo["estado"] == 0 ? "Inactivo":
                ($equipo["estado"] == 1 ? "Activo": "Manetenimiento") ?>
        <tr>
            <td style="width: 20%; border: solid 1px #000000;"><?=$equipo["numero_serie"]?></td>
            <td style="width: 55%; border: solid 1px #000000;text-align: left; word-wrap: break-word"><?=$equipo["descripcion"]?></td>
            <td style="width: 25%; border: solid 1px #000000; text-align: center;"><?=$estado?> </td>
        </tr>
        <?php endforeach;?>
        <tr>
