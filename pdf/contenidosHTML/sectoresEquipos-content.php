...
<page orientation="portrait" >
    ...
    <table cellspacing="0" style="width: 100%; margin: 3%;">
        ...
        <tr>
            <td style="width: 100%; text-align: center; text-decoration: underline; font-weight: bold; font-size: 20pt">
                ...
                REPORTE DE EQUIPOS POR SECTORES
            </td>
        </tr>
    </table>
    ...
    <table cellspacing="0" style="padding: 1px; width: 100%; border: solid 2px #000000; font-size: 11pt; ">
        ...
        <tr>
            <th style="width: 30%; border: solid 1px #000000;text-align: center;">Equipos</th>
            <th style="width: 70%; border: solid 1px #000000;">Sectores</th>
        </tr>

    <?php foreach ($registros as $registro):?>
    <tr>
        <td style="width: 30%; border: solid 1px #000000; text-align: center;"><?=$registro["equipos"]?></td>
        <td style="width: 70%; border: solid 1px #000000;"><?=$registro["sector"]?></td>
    </tr>
    <?php endforeach;?>
    ...
    <table cellspacing="0" style="padding: 1px; width: 100%; border: solid 2px #000000; font-size: 11pt; ">
        ...
        <tr>
            ...
            <th style="width: 25%; border: solid 1px #000000;">Sectores</th>
        </tr>
        ...
        <tr>
            ...
            <td style="width: 25%; border: solid 1px #000000;"><?=$equipo["sector"]?> </td>
        </tr>
        <?php endforeach;?>
        <tr>
