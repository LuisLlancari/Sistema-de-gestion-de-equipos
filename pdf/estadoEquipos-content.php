...
<page orientation="paysage" >
    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
            <td style="width: 10%;">
                <img style="width: 100%" src="../test/reparacionBANNER.jpeg" alt="reparacionBANNER" >
            </td>
        ...
        <tr>
            <td style="width:55%;">
                <table cellspacing="0" style="padding: 1px; width: 100%; border: solid 2px #000000; font-size: 11pt; ">
                    ...
                    <?php foreach ($datosRecibidos as $registro):?>
                    <tr>
                        <td style="width: 15%; border: solid 1px #000000;"><?$registro["cantidad"]?></td>
